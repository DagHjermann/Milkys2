...
if (FALSE){
  ...
  model_from_medians("HG", "Gadus morhua", "Muskel", "30B", "DW", 1980:2019, data_med)$statistics
...
if (!add_extra_series){   # this is the normal case - we have calculated trends for all series
  ...
  fn1 <- paste0(pattern_10yr, file_date, ".rds")
  fn2 <- paste0(pattern_long, file_date, ".rds")
  ...
  result_10yr_original <- result_10yr_original %>%
    ...
    safe_anti_join(result_10yr, 
                   ...
                   na_matches = "never",
                   check = "BUV")
  cat("result_10yr: ", nrow(result_10yr_original), "after removing overlapping time series")
  ...
  result_long_original <- result_long_original %>%
    safe_anti_join(result_long, 
                 by = c("STATION_CODE", "PARAM", "LATIN_NAME", "TISSUE_NAME", "Basis"),
                 na_matches = "never",
                 check = "BUV")
  cat("result_long: ", nrow(result_long_original), "after removing overlapping time series")
  
  # Add the newly made series
  result_10yr_new <- bind_rows(result_10yr_original, result_10yr)
  result_long_new <- bind_rows(result_long_original, result_long)
  
  cat("\n")
  cat("Final number of data sets (after adding/replacing series): \n")
  ...
  if (check1 == 0 & check2 == 0){
    ...
    stop("ERROR: Series are not unique! This must be fixed.\n")
  }
  ...
  if (date_existing_1 == file_date){
    fn1_old <- paste0(pattern_10yr, file_date, "_OLD.rds")
    file.copy(paste0("Data/", fn1), paste0("Data/", fn1_old))
  }
  if (date_existing_2 == file_date){
    fn2_old <- paste0(pattern_long, file_date, "_OLD.rds")
    file.copy(paste0("Data/", fn2), paste0("Data/", fn2_old))
  }
  
  saveRDS(result_10yr_new, paste0("Data/", fn1, ".rds"))
  saveRDS(result_long_new, paste0("Data/", fn2, ".rds"))

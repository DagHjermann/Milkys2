...
filepattern <- "109_adjusted_data_ELU2_"       # entire file name except date and extension                    #ELU-version
...
write.csv(proref_updated03 %>% rename(Proref = Q95), "Input_data/Lookup_tables/Lookup_proref_ELU.csv")                    #ELU-version
...
filename <- paste0("Data/110_mediandata_updated_ELU_", data_list$file_date, ".rds")                               #ELU

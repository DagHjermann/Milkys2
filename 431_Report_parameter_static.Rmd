...
for (speciesgroup in 1:2){
  ...
  if (params$ratioplot == "EQS with proref"){
...
if (params$ratioplot %in% c("EQS with proref", "EQS")){
  
  print(plot_eqsratio_list[[1]])
  print(plot_eqsratio_list[[2]])
...
if (params$ratioplot %in% c("Proref")){
  
  print(plot_prorefratio_list[[1]])
  print(plot_prorefratio_list[[2]])

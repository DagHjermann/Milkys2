...
```{r 05_trend_create_plots, warning=FALSE}
...
gg_trends <- c("long", "short") %>%
  ...
  geom_label(aes(y = 0, label = Trend_text), fill = "white", color = "blue3", label.size = 0) +
...
filename <- glue::glue("Figures/430_{params$param}_{tissue}_combo.png")
ggsave(filename, ggcomb, width = 14, height = 8, dpi = 200)

filename <- glue::glue("Figures/430_{params$param}_{tissue}_combo_leg.png")

...
for (speciesgroup in speciesgroups){
  ...
  if (params$param %in% "HG" & speciesgroup == 1){
    filename <- glue::glue("Figures/431/{params$param}-{params$basis_medians}_combo_{speciesgroup}.png")
  } else {
    filename <- glue::glue("Figures/431/{params$param}_combo_{speciesgroup}.png")
  }
...
if (params$eqsplot == TRUE){
  ...
  for (speciesgroup in speciesgroups){
    ...
    # Set name of figure file (mercury in cod+birds is treated as a special case)
    if (params$param %in% "HG" & speciesgroup == 1){
      filename <- glue::glue("Figures/431/{params$param}-{params$basis_medians}_eqsratio_ord_{speciesgroup}.png")
    } else {
...
for (speciesgroup in speciesgroups){
  ...
  # Set name of figure file (mercury in cod+birds is treated as a special case)
  if (params$param %in% "HG" & speciesgroup == 1){
    filename <- glue::glue("Figures/431/{params$param}-{params$basis_medians}_prorefratio_ord_{speciesgroup}.png")
  } else {

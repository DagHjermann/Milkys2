##########################################################################################################################
# 36D fix_utf8                 Reading a UTF-8 file using default Windows-1252 encoding, changes for instance "?" to strange "characters" such as "ø" 
#                              This function attempts to change them to UTF-8 characters (such as "?") 
...
#                              Note that it won't succeed with all characters, for instance several UTF-8 characters are changed to "?" by Windows-1252
#                                "ÿ" can be both "?" and "?".
...
fix_utf8 <- function(string_vector){
  ...
  #   otherwise "?" will be found and replaced before "ø"

...
#o#o#o#o#o#o#o#o#o#o#o#o#o#o#o#o
#
# OOO set work directory back to normal ----
#
#o#o#o#o#o#o#o#o#o#o#o#o#o#o#o#o
...
param <- "Dioksiner"
param <- "CB118"
station <- "Glencore kai"
dat_all_prep3 %>%
  filter(Station == station & PARAM == param) %>%
  select(Station, PARAM, MYEAR, VALUE, FLAG1, UNIT, Basis)

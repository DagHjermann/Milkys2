...
#install.packages("devtools")  #ELU

#install.packages("svDialogs") #ELU
#install.packages("DBI") #ELU
#install.packages("odbc") #ELU

#devtools::install("C:/Data/niRvana/")  #ELU
devtools::install("niRvana")  #ELU testing, pakke i Milkys2
library(dplyr)
library(niRvana)
library(lubridate)
library(knitr)       # kable()
...
set_credentials()  #ELU fikk "Username/password is not correct."

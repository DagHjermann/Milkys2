...
X <- plot_medians_and_trends(c("HG", "Gadus morhua", "Muskel", "30B",  "WWa"), 
                             eqs_type = "line", xlim = c(1976, 2020), ylim = c(0, ymax))
...
type <- "line"
folder <- "Figures_401/Til 2020-rapporten"
```
...
```
# plots til MILKYS-rapport for 2020. ELU. Hg + MCCP
```{r}

#X <- plot_medians_and_trends(c("HG", "Mytilus edulis", "Whole soft body", "57A",  "WW"),
              #             eqs_type = type, xlim = c(1972, 2020), eqs_x = 1982, ylim = c(0, 0.25))
#save_trendplot(X, folder)

#X <- plot_medians_and_trends(c("HG", "Gadus morhua", "Muskel", "30B",  "WW"),
       #                    eqs_type = type, xlim = c(1972, 2020), eqs_x = 1972, ylim = c(0, 0.44))
#save_trendplot(X, folder)
...
#X <- plot_medians_and_trends(c("HG", "Gadus morhua", "Muskel", "36B",  "WW"),
              #           eqs_type = type, xlim = c(1972, 2019), eqs_x = 1972, ylim = c(0, 0.44))
#save_trendplot(X, folder)
...
X <- plot_medians_and_trends(c("HG", "Gadus morhua", "Muskel", "13B",  "WWa"),
                             eqs_type = type, xlim = c(2006, 2020), eqs_x = 2006, ylim = c(0, 0.44))
save_trendplot(X, folder)

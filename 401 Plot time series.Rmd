...
X <- plot_medians_and_trends(c("HBCDA", "Gadus morhua", "Lever", "71B",  "WW"), 
                            eqs_type = type, xlim = c(2011, 2019), eqs_x = 2011, ylim = c(0, 8.5))
save_trendplot(X, folder)
...
X <- 
  plot_medians_and_trends(c("SCCP", "Gadus morhua", "Lever", "24B",  "WW"), 
                            eqs_type = type, xlim = c(2014, 2019), eqs_x = 2014, ylim = c(0, 800))
save_trendplot(X, folder)

#X <- 
 # plot_medians_and_trends(c("SCCP", "Gadus morhua", "Lever", "53B",  "WW"), 

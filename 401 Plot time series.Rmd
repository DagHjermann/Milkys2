...
# Avoid stringr due to trouble with stringi (and stringi is slow to )
# fns_ver <- stringr::str_extract(fns, "ver[0-9]+") %>% stringr::str_extract("[0-9]+") %>% as.numeric()

retrieve <- function(string, expr){
  X <- regexpr(expr, string)
  substr(string, X, X + attr(X, "match.length") - 1)
}

fns_ver <- retrieve(fns, "ver[0-9]+") %>% retrieve("[0-9]+") %>% as.numeric()
...
X <- plot_medians_and_trends(c("HG", "Gadus morhua", "Muskel", "30B",  "WW"),  
                             eqs_type = "line", xlim = c(1976, 2021), ylim = c(0, ymax), add_trend_symbols = TRUE)
...
### Test 3
```{r}
plot_medians_and_trends(c("PA", "Mytilus edulis", "Whole soft body", "30A",  "WW"), 
                             eqs_type = type, xlim = c(2000, 2021), eqs_x = 2006, ylim = c(0, 10.0))
```
...
```{r}
plot_medians_and_trends(c("OCS", "Gadus morhua", "Lever", "30B",  "WW"), 
...
type <- "line"
folder <- "Figures_401/Til 2021-rapporten"
```
#PAH-figur til Mildir juli 2022:
```{r}
#X <- plot_medians_and_trends(c("P_S", "Mytilus edulis", "Whole soft body", "30A",  "WW"), 
 #                            eqs_type = type, xlim = c(1984, 2021), eqs_x = 2006, ylim = c(0, 100.0))

#save_trendplot(X, folder)

#X <- plot_medians_and_trends(c("P_S", "Mytilus edulis", "Whole soft body", "I301",  "WW"), 
 #                           eqs_type = type, xlim = c(1984, 2021), eqs_x = 2006, ylim = c(0, 400.0))
#save_trendplot(X, folder)


X <- plot_medians_and_trends(c("P_S", "Mytilus edulis", "Whole soft body", "I304",  "WW"), 
                             eqs_type = type, xlim = c(1984, 2021), eqs_x = 2006, ylim = c(0, 100.0))
save_trendplot(X, folder)

```
# flere plots til MILKYS-rapport for 2020
```{r}
#X <- plot_medians_and_trends(c("AG", "Mytilus edulis", "Whole soft body", "31A",  "WW"), 
#                          eqs_type = type, xlim = c(2006, 2020), eqs_x = 2006, ylim = c(0, 0.065))
#X
#save_trendplot(X, folder)

X <- plot_medians_and_trends(c("CB28", "Gadus morhua", "Lever", "15B",  "WW"), 
                          eqs_type = type, xlim = c(2000, 2021), eqs_x = 2000, ylim = c(0, 30))
X

# X <- plot_medians_and_trends(c("CD", "Mytilus edulis", "Whole soft body", "11X",  "WW"), 
#                             eqs_type = type, xlim = c(1991, 2020), eqs_x = 1991, ylim = c(0, 0.45))
# save_trendplot(X, folder)

 # X <- plot_medians_and_trends(c("CB_S7", "Mytilus edulis", "Whole soft body", "10A2",  "WW"),
 #                              eqs_type = type, xlim = c(1991, 2020), eqs_x = 1991, ylim = c(0, 6.0))
 # save_trendplot(X, folder)
 # 
 # X <- plot_medians_and_trends(c("CB_S7", "Mytilus edulis", "Whole soft body", "11X",  "WW"),
 #                              eqs_type = type, xlim = c(1991, 2020), eqs_x = 1991, ylim = c(0, 6.0))
 # save_trendplot(X, folder)
 # 
 # X <- plot_medians_and_trends(c("CB_S7", "Mytilus edulis", "Whole soft body", "22A",  "WW"),
 #                              eqs_type = type, xlim = c(1983, 2020), eqs_x = 1983, ylim = c(0, 6.0))
 # save_trendplot(X, folder)
# 
# X <- plot_medians_and_trends(c("CB_S7", "Mytilus edulis", "Whole soft body", "26A2",  "WW"),
#                              eqs_type = type, xlim = c(2009, 2020), eqs_x = 2009, ylim = c(0, 6.0))
# save_trendplot(X, folder)
# 
 #X <- plot_medians_and_trends(c("CB_S7", "Mytilus edulis", "Whole soft body", "56A",  "WW"),
            #                  eqs_type = type, xlim = c(1980, 2020), eqs_x = 1980, ylim = c(0, 6.0))
 
 #save_trendplot(X, folder)
# 
 # X <- plot_medians_and_trends(c("CB_S7", "Mytilus edulis", "Whole soft body", "57A",  "WW"),
 #                              eqs_type = type, xlim = c(1980, 2020), eqs_x = 1980, ylim = c(0, 6.0))
 # 
 # save_trendplot(X, folder)
# 
 # X <- plot_medians_and_trends(c("CB_S7", "Mytilus edulis", "Whole soft body", "64A",  "WW"),
 #                              eqs_type = type, xlim = c(2009, 2020), eqs_x = 2009, ylim = c(0, 6.0))
 # 
 # save_trendplot(X, folder)
# 
 # X <- plot_medians_and_trends(c("CB_S7", "Mytilus edulis", "Whole soft body", "65A",  "WW"), 
 #                              eqs_type = type, xlim = c(1980, 2020), eqs_x = 1980, ylim = c(0, 6.0))
 # save_trendplot(X, folder)
# 
 # X <- plot_medians_and_trends(c("CB_S7", "Mytilus edulis", "Whole soft body", "76A2",  "WW"), 
 #                              eqs_type = type, xlim = c(2011, 2020), eqs_x = 2011, ylim = c(0, 6.0))
 # save_trendplot(X, folder)
# 
 # X <- plot_medians_and_trends(c("CB_S7", "Mytilus edulis", "Whole soft body", "98A2",  "WW"), 
 #                              eqs_type = type, xlim = c(1991, 2020), eqs_x = 1991, ylim = c(0, 6.0))
 # save_trendplot(X, folder)
 # 
 # X <- plot_medians_and_trends(c("CB_S7", "Mytilus edulis", "Whole soft body", "I023",  "WW"), 
 #                              eqs_type = type, xlim = c(1987, 2020), eqs_x = 1987, ylim = c(0, 6.0))
 # save_trendplot(X, folder)

```
# ekstra plots til SIX: 15B: PYR1OH, Pb, Cd og Zn 
```{r}
# X <- plot_medians_and_trends(c("CD", "Gadus morhua", "Lever", "15B",  "WW"), 
#                             eqs_type = type, xlim = c(1984, 2020), eqs_x = 1984, ylim = c(0, 0.045))
# save_trendplot(X, folder)

X <- plot_medians_and_trends(c("PB", "Gadus morhua", "Lever", "15B",  "WW"), 
                            eqs_type = type, xlim = c(1984, 2020), eqs_x = 1984, ylim = c(0, 0.15))
save_trendplot(X, folder)

#X <- plot_medians_and_trends(c("ZN", "Gadus morhua", "Lever", "15B",  "WW"), 
     #                       eqs_type = type, xlim = c(1984, 2020), eqs_x = 1984, ylim = c(0, 60))
#save_trendplot(X, folder)

#X <- plot_medians_and_trends(c("PYR", "Mytilus edulis", "Whole soft body", "30A", "WW"), 
 #                        eqs_type = type, xlim = c(1990, 2020), eqs_x = 1990, ylim = c(0, 50))
#X

#X <- plot_medians_and_trends(c("PYR1OH", "Gadus morhua", "Galle", "15B", "WW"),
#                            eqs_type = type, xlim = c(1998, 2020), eqs_x = 1998, ylim = c(0, 1100))
# Add OSPAR BAC
#X$gg + 
...
```
# flere plots til MILKYS-rapport for 2020. ELU. VDSI
```{r}
X <- plot_medians_and_trends(c("VDSI", "Nucella lapillus", "Whole soft body", "36G",  "WW"), 
                           eqs_type = type, xlim = c(1987, 2020), eqs_x = 1987, ylim = c(0, 5.0))

save_trendplot(X, folder)

#X <- plot_medians_and_trends(c("EROD", "Gadus morhua", "Lever", "30B",  "WW"), 
 #                            eqs_type = type, xlim = c(1993, 2020), eqs_x = 1993, ylim = c(0, 300.0))
#save_trendplot(X, folder)
...
```
# plots til MILKYS-rapport for 2020. ELU. HCB + QCB + PBDE + HBCD + SCCP
```{r}

#X <- plot_medians_and_trends(c("SCCP", "Gadus morhua", "Lever", "24B",  "WW"), 
         #                    eqs_type = type, xlim = c(1984, 2020), eqs_x = 1984, ylim = c(0, 800))
#save_trendplot(X, folder)
...
#X <- plot_medians_and_trends(c("SCCP", "Mytilus edulis", "Whole soft body", "I023",  "WW"), 
 #                            eqs_type = type, xlim = c(2011, 2020), eqs_x = 2011, ylim = c(0, 21.0))
 #save_trendplot(X, folder)

#X <- plot_medians_and_trends(c("HBCDA", "Gadus morhua", "Lever", "71B",  "WW"), 
#                            eqs_type = type, xlim = c(1996, 2020), eqs_x = 1997, ylim = c(0, 7.5))
#save_trendplot(X, folder)
 
#X <- plot_medians_and_trends(c("HBCDA", "Mytilus edulis", "Whole soft body", "30A",  "WW"), 
  #                         eqs_type = type, xlim = c(1996, 2020), eqs_x = 1997, ylim = c(0, 2.2))
#save_trendplot(X, folder)

#X <- plot_medians_and_trends(c("BDE6S", "Gadus morhua", "Lever", "30B",  "WW"),
               #             eqs_type = type, xlim = c(1987, 2020), eqs_x = 1988, ylim = c(0, 105.0))
#save_trendplot(X, folder)
...
#X <- plot_medians_and_trends(c("BDE6S", "Gadus morhua", "Lever", "80B",  "WW"), 
 #                           eqs_type = type, xlim = c(2004, 2020), eqs_x = 2004, ylim = c(0, 105.0))
#save_trendplot(X, folder)
...
#X <- plot_medians_and_trends(c("QCB", "Gadus morhua", "Lever", "53B",  "WW"), 
 #                             eqs_type = type, xlim = c(1990, 2020), eqs_x = 1990, ylim = c(0, 15.0))
#save_trendplot(X, folder)

#X <- plot_medians_and_trends(c("HCB", "Gadus morhua", "Lever", "30B",  "WW"), 
 #                            eqs_type = type, xlim = c(1988, 2020), eqs_x = 1988, ylim = c(0, 20.0))
#save_trendplot(X, folder)
...
#X <- plot_medians_and_trends(c("HCB", "Mytilus edulis", "Whole soft body", "I133",  "WW"), 
 #                            eqs_type = type, xlim = c(1988, 2020), eqs_x = 1988, ylim = c(0, 10.5))
#save_trendplot(X, folder)

```
# plots til MILKYS-rapport for 2020. ELU. PCB + DDEPP
```{r}
X <- plot_medians_and_trends(c("CB_S7", "Mytilus edulis", "Whole soft body", "31A",  "WW"), 
                             eqs_type = type, xlim = c(1980, 2020), eqs_x = 1988, ylim = c(0, 50.0))
save_trendplot(X, folder)
...
#X <- plot_medians_and_trends(c("DDEPP", "Mytilus edulis", "Whole soft body", "22A",  "WW"), 
         #                    eqs_type = type, xlim = c(1986, 2020), eqs_x = 1986, ylim = c(0, 1.0))
#save_trendplot(X, folder)

```
# plots til MILKYS-rapport for 2020. ELU. Metaller
```{r}

#X <- plot_medians_and_trends(c("AG", "Mytilus edulis", "Whole soft body", "26A2",  "WW"), 
 #                           eqs_type = type, xlim = c(2010, 2020), eqs_x = 2010, ylim = c(0, 0.7))
#save_trendplot(X, folder)

#X <- plot_medians_and_trends(c("CD", "Mytilus edulis", "Whole soft body", "I304",  "WW"), 
 #                           eqs_type = type, xlim = c(1991, 2020), eqs_x = 1991, ylim = c(0, 0.37))
#save_trendplot(X, folder)

#X <- plot_medians_and_trends(c("CD", "Gadus morhua", "Lever", "30B",  "WW"), 
        #                    eqs_type = type, xlim = c(1980, 2020), eqs_x = 1980, ylim = c(0, 0.28))
#save_trendplot(X, folder)


X <- plot_medians_and_trends(c("PB", "Mytilus edulis", "Whole soft body", "30A",  "WW"), 
                            eqs_type = type, xlim = c(1976, 2021), eqs_x = 1976, ylim = c(0, 2.5))
X

plot_medians_and_trends(c("PB", "Mytilus edulis", "Whole soft body", "I304",  "WW"), 
                            eqs_type = type, xlim = c(1976, 2021), eqs_x = 1976, ylim = c(0, 2.5))
...
#X <- plot_medians_and_trends(c("PB", "Mytilus edulis", "Whole soft body", "I304",  "WW"), 
                            #eqs_type = type, xlim = c(1978, 2020), eqs_x = 1978, ylim = c(0, 2.0))
#save_trendplot(X, folder)

#X <- plot_medians_and_trends(c("CU", "Gadus morhua", "Lever", "15B",  "WW"), 
 #                           eqs_type = type, xlim = c(1986, 2020), eqs_x = 1986, ylim = c(0, 18.0))
#save_trendplot(X, folder)

#X <- plot_medians_and_trends(c("AG", "Gadus morhua", "Lever", "15B",  "WW"), 
 #                           eqs_type = type, xlim = c(2008, 2020), eqs_x = 2008, ylim = c(0, 2.3))
#save_trendplot(X, folder)

#X <- plot_medians_and_trends(c("AG", "Gadus morhua", "Lever", "15B",  "WWa"), 
                #            eqs_type = type, xlim = c(2008, 2020), eqs_x = 2008, ylim = c(0, 2.5))
#save_trendplot(X, folder)

#X <- plot_medians_and_trends(c("NI", "Mytilus edulis", "Whole soft body", "30A",  "WW"), 
 #                           eqs_type = type, xlim = c(2007, 2020), eqs_x = 2007, ylim = c(0, 1.9))
#save_trendplot(X, folder)
...
#X <- plot_medians_and_trends(c("NI", "Gadus morhua", "Lever", "15B",  "WW"), 
                #            eqs_type = type, xlim = c(2007, 2020), eqs_x = 2007, ylim = c(0, 0.67))
#save_trendplot(X, folder)


#X <- plot_medians_and_trends(c("CR", "Mytilus edulis", "Whole soft body", "30A",  "WW"), 
           #                 eqs_type = type, xlim = c(2007, 2020), eqs_x = 2007, ylim = c(0, 2.15))
#save_trendplot(X, folder)
...
#X <- plot_medians_and_trends(c("CR", "Mytilus edulis", "Whole soft body", "11X",  "WW"), 
                      #      eqs_type = type, xlim = c(2007, 2020), eqs_x = 2007, ylim = c(0, 2.15))
#save_trendplot(X, folder)

```
# plots til MILKYS-rapport for 2020+2021. ELU. Hg + MCCP
```{r}

X <- plot_medians_and_trends(c("HG", "Mytilus edulis", "Whole soft body", "30A",  "WW"),
                           eqs_type = type, xlim = c(1972, 2021), eqs_x = 1982, ylim = c(0, 0.025))
X
#save_trendplot(X, folder)

#X <- plot_medians_and_trends(c("CR", "Somateria mollissima", "Blood", "19N",  "WW"),
#                            eqs_type = type, xlim = c(2017, 2021), eqs_x = 2017, ylim = c(0, 2.1))
#X
# save_trendplot(X, folder)

# X <- plot_medians_and_trends(c("HG", "Gadus morhua", "Muskel", "30B",  "WW"),
#                            eqs_type = type, xlim = c(1972, 2021), eqs_x = 1972, ylim = c(0, 0.44))
# save_trendplot(X, folder)
# 
...
# X <- plot_medians_and_trends(c("HG", "Gadus morhua", "Muskel", "02B",  "WW"),
#                           eqs_type = type, xlim = c(2009, 2021), eqs_x = 2009, ylim = c(0, 0.44))
# save_trendplot(X, folder)
# 
# X <- plot_medians_and_trends(c("HG", "Gadus morhua", "Muskel", "02B",  "WWa"),
#                           eqs_type = type, xlim = c(2009, 2021), eqs_x = 2009, ylim = c(0, 0.44))
# save_trendplot(X, folder)

# X <- plot_medians_and_trends(c("HG", "Gadus morhua", "Muskel", "71B",  "WW"),
#                           eqs_type = type, xlim = c(2009, 2021), eqs_x = 2009, ylim = c(0, 0.44))
# save_trendplot(X, folder)


# X <- plot_medians_and_trends(c("HG", "Gadus morhua", "Muskel", "13B",  "WW"),
#                            eqs_type = type, xlim = c(2006, 2021), eqs_x = 2006, ylim = c(0, 0.44))
# save_trendplot(X, folder)
# 
...
#                             eqs_type = type, xlim = c(1976, 2021), eqs_x = 1976, ylim = c(0, 0.44))
# save_trendplot(X, folder)
# 
...
# X <- plot_medians_and_trends(c("HG", "Gadus morhua", "Muskel", "53B",  "WW"),
#                            eqs_type = type, xlim = c(1976, 2021), eqs_x = 1976, ylim = c(0, 0.44))
# save_trendplot(X, folder)

# X <- plot_medians_and_trends(c("HG", "Gadus morhua", "Muskel", "23B",  "WW"),
#                            eqs_type = type, xlim = c(1980, 2021), eqs_x = 1980, ylim = c(0, 0.44))
# save_trendplot(X, folder)

# X <- plot_medians_and_trends(c("HG", "Gadus morhua", "Muskel", "24B",  "WW"),
#                             eqs_type = type, xlim = c(2013, 2021), eqs_x = 2013, ylim = c(0, 0.4))
# save_trendplot(X, folder)


# X <- plot_medians_and_trends(c("HG", "Gadus morhua", "Muskel", "28B",  "WW"),
#                             eqs_type = type, xlim = c(2010, 2021), eqs_x = 2010, ylim = c(0, 0.6))
# save_trendplot(X, folder)

# X <- plot_medians_and_trends(c("HG", "Gadus morhua", "Muskel", "80B",  "WW"),
#                             eqs_type = type, xlim = c(2006, 2021), eqs_x = 2006, ylim = c(0, 0.44))
# save_trendplot(X, folder)

# X <- plot_medians_and_trends(c("HG", "Gadus morhua", "Muskel", "96B",  "WW"),
#                             eqs_type = type, xlim = c(2010, 2021), eqs_x = 2010, ylim = c(0, 0.44))
# save_trendplot(X, folder)

# X <- plot_medians_and_trends(c("HG", "Gadus morhua", "Muskel", "98B1",  "WW"),
#                             eqs_type = type, xlim = c(1984, 2021), eqs_x = 1984, ylim = c(0, 0.44))
# save_trendplot(X, folder)
...
# X <- plot_medians_and_trends(c("HG", "Gadus morhua", "Muskel", "45B2",  "WW"),
#                            eqs_type = type, xlim = c(2009, 2021), eqs_x = 2009, ylim = c(0, 0.44))
# save_trendplot(X, folder)

# X <- plot_medians_and_trends(c("HG", "Gadus morhua", "Muskel", "10B",  "WW"),
#                            eqs_type = type, xlim = c(1988, 2021), eqs_x = 1988, ylim = c(0, 0.2))
# save_trendplot(X, folder)

# X <- plot_medians_and_trends(c("HG", "Gadus morhua", "Muskel", "19B",  "WW"),
#                            eqs_type = type, xlim = c(2014, 2021), eqs_x = 2014, ylim = c(0, 0.2))
# save_trendplot(X, folder)

# X <- plot_medians_and_trends(c("HG", "Gadus morhua", "Muskel", "20B",  "WW"),
#                            eqs_type = type, xlim = c(2014, 2021), eqs_x = 2014, ylim = c(0, 0.2))
# save_trendplot(X, folder)


#X <- plot_medians_and_trends(c("HG", "Mytilus edulis", "Whole soft body", "57A",  "WW"),
              #             eqs_type = type, xlim = c(1972, 2021), eqs_x = 1982, ylim = c(0, 0.25))
#save_trendplot(X, folder)

#X <- plot_medians_and_trends(c("HG", "Platichthys flesus", "Muskel", "33F",  "WW"),
 #                         eqs_type = type, xlim = c(1976, 2020), eqs_x = 1976, ylim = c(0, 0.44))
#save_trendplot(X, folder)

#X <- plot_medians_and_trends(c("MCCP", "Gadus morhua", "Lever", "30B",  "WW"),
 #                          eqs_type = type, xlim = c(2010, 2020), eqs_x = 2010, ylim = c(0, 1000))
#save_trendplot(X, folder)

#X <- plot_medians_and_trends(c("MCCP", "Gadus morhua", "Lever", "36B",  "WW"),
 #                          eqs_type = type, xlim = c(2010, 2020), eqs_x = 2010, ylim = c(0, 1000))
#save_trendplot(X, folder)

#X <- plot_medians_and_trends(c("MCCP", "Gadus morhua", "Lever", "02B",  "WW"),
#                           eqs_type = type, xlim = c(2010, 2020), eqs_x = 2010, ylim = c(0, 1000))
#save_trendplot(X, folder)

...
#
# Name list using the first value of 'Station' 
#
names(dat_list_selected) <- dat_list_selected %>% map_chr(~.$Station[1])
...
# Check manually:
dat_list_selected[["15B Farsund"]] %>% View()

# Fix (HARD-CODED):
dat_list_selected[["15B Farsund"]] <- dat_list_selected[["15B Farsund"]][1:15,]
...
```{r}
dat_1 <- bind_rows(dat_list_selected)

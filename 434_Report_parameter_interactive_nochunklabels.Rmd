...
filename_trends <- "Data/milkys4_903_trends_01.rds"                   # update
...
dat_raw2 <- get_data_raw(params$param, "Somateria mollissima", "Blod", "WW",
                         include_year=current_year, filename_109 = filename_109)
dat_raw3 <- get_data_raw(params$param, "Somateria mollissima", "Egg", "WW",
                         include_year=current_year,filename_109 = filename_109)  

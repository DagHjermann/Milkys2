...
filename_trends <- "Data/milkys4_01_trends_nivaformat.rds"            # update
...
df_trend_orig <- readr::read_csv("Data/milkys4_01_trends.csv") 
...
df_trend <- df_trend_orig %>%
  ...
  mutate(
    PARAM = ifelse(is.na(PARAM), determinand, PARAM),
...
saveRDS(df_trend, filename_trends)

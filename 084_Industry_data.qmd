...
lookup_stations <- tibble::tribble(
  ...
  71598, "I964/I964b", "Nord for Toraneskaia", "Ransfjorden",
  47184, "I965", "Moholmen", "Ransfjorden",
  47181, "I969", "Bjørnebærviken", "Ransfjorden"
)
...
check <- df_hoy_02 %>%
  distinct(STATION_ID, STATION_CODE, STATION_CODEs)
...
saveRDS(df_hoy_02, paste0(here(), "/App02_Industry_data/data_chem_industry_ranssfjord_2024.rds"))

...
lookup_units <- data.frame(
  ENHETER = c("µg/kg","µg/kg"), UNIT = c("MG_P_KG", "UG_P_KG"))
...
#### Set STATION_NAME in accordance to existing names  accordfand
...
lookup_stations <- data.frame(
  ...
  STATION_CODE = c("Glencore kai", "Hanneviksbukta", "Kolsdalsbukta", 
                    "Myrodden", "Dvergsøya, referansestasjon"), 
  STATION_NAMEs = c("Glencore kai blåskjell stedegne", "Hanneviksbukta blåskjell stedegne", "Kolsdalsbukta blåskjell stedegne", 

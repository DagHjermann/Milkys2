...
dat_all_prep1 <- lc_prepare(dat_all,
                           x = "MYEAR",
                           y = "VALUE_WW", 
                           censored = "FLAG1",
                           log = TRUE,
...
# version max that tolerates being given an x with length zero without warning
...
get_splines_results_seriesno_s(58, 
                             data = dat_all_prep3, 
                             data_series = dat_series_trend, 
                             foldername = "Data/125_results_2021", 
                             raftery = TRUE)
...
result <- foreach(i = series_no, 
                  .export = c("dat_all_prep3","dat_series_trend")) %dopar%
                   get_splines_results_seriesno_s(i, 
                                 dat_all_prep3, dat_series_trend, foldername = "Data/125_results_2021",
                                 raftery = TRUE)
t1 <- Sys.time()
t1-t0

...
if (FALSE){
  ...
  cat("Number of stations per parameter group, 2021 \n")  
  xtabs(~MGR.Group, dat_med2 %>% filter(MYEAR == 2021) %>% distinct(STATION_CODE, MGR.Group))
  cat("\n")
  cat("Number of parameters per parameter group, 2021 \n")  
...
param_values <- c("D4", "D5", "D6", "1-OH-naftalen", "2-OH-fenantren", "2-OH-naftalen", "3-OH-fenantren", 
"4-OH-fenantren", "PA1OH", "PYR1OH", "BAP3OH", "EROD", "ALA-D")

param_values <- c("D4", "D5", "D6")

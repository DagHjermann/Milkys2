...
param_values <- c("PFBS", "PFDcA", "Perfluordekansulfonat (PFDS)", "PFHpA", "PFHxA", 
                  "PFHxS", "PFNA", "PFOA", "PFOS", "PFOSA", "Perfluortridekansyre (PFTrA)", 
                  "PFUdA")
# param_values <- c("PFOA", "PFOS")

...
if (FALSE){
  ...
  tab <- xtabs(~PARAM, dat_med2 %>% filter(MYEAR == 2021 & MGR.Group == "CCPs"))
  tab
  dput(names(tab))
}
...
param_values <- c("D4", "D5", "D6", "PA1OH", "PYR1OH", "BAP3OH", "EROD", "ALA-D")

param_values <- c("EROD", "ALA-D", "MCCP eksl. LOQ", "SCCP eksl. LOQ")

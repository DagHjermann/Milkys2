...
save_folder_excel <- paste0("Files_to_ICES/", selected_year, "/Excel")
...
folder <- "Files_from_Jupyterhub_2022/Raw_data"
dir(folder, "105_*")

data_all <- readRDS(paste0(folder, "/", "105_data_with_uncertainty_2023-09-12.rds")) %>%
  # Set 36A to 36A1
  mutate(
...
dir(folder, "150_*")
data_ind_fish <- readRDS(paste0(folder, "/", "150_Fish_individual_data_ELU_2022.rds"))
...
df_samples <- readRDS(paste0(folder, "/Labware_samples_2022_2023-09-12.rds")) %>%

...
df_duplicates <- dat_new1 %>%
  add_count(STATION_CODE, LATIN_NAME, TISSUE_NAME, MYEAR, SAMPLE_ID, NAME) %>%
  filter(n > 1)
...
if (check == 0){
  ...
  cat("WARNING! 'Lookup table - preferred parameter units.csv' contains some PARAM with more than one preferred unit")
  cat("\n")
  cat("Fix 'Lookup table - preferred parameter units.csv' and repeat")
  cat("\n")
}  

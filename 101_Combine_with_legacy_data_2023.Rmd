...
filepattern <- paste0("01_df_", lastyear, "_notstandard_")    # file name except date and extension #ELU endrer fra 80_df til 01_df
...
### a1b. Change name of CAUGHT                        #ELU feil script til denne overskriften?
...
tab1b <- apply(tab1a > 0, 2, sum)                                       #ELU: får feil her, kjører ikke dette scriptet
